/** Inline SVGs for communication toolbar — no extra icon dependency. */
...
/** Vertical ellipsis — split-button menu trigger. */
...
/** Envelope — compose / new email. */
export function IconNewEmail({ className }: { className?: string }) {
  return (
    <svg
      className={className ?? iconClass}
      viewBox="0 0 24 24"
...
/** Arrow forward — follow-up / next outreach. */
export function IconFollowUp({ className }: { className?: string }) {
  return (
    <svg
      className={className ?? iconClass}
      viewBox="0 0 24 24"
