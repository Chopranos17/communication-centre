...
const iconWrap = (title: string, className: string | undefined, children: ReactNode) => (
  <span
    className={`inline-flex shrink-0 text-[var(--icon-default)] ${className ?? ""}`}
    title={title}
    aria-hidden
  >
    {children}
...
/** Gear / automation (system emails, CRM, in-app system notifications). */
