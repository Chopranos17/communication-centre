...
async function main() {
  ...
  const candidateDefs: CDef[] = [
    ...
    {
      name: "Ananya Rao",
      email: "ananya.rao.candidate@example.com",
      phone: "+919844433322",
      whatsapp_number: "+919844433322",
      stage: "pre_offer",
      source: "job_portal",
      recruiter_id: "emp-rec-001",
      hiring_lead_id: "emp-hl-001",
    ...
    {
      name: "Karan Patel",
      email: "karan.patel+cc@example.com",
      phone: "+919877766655",
      whatsapp_number: "+919877766655",
      stage: "applied",
      source: "CRM",
    ...
    {
      name: "Divya Nair",
      email: "divya.nair.apply@example.com",
      phone: "+919833344455",
      whatsapp_number: "+919833344455",
      stage: "shortlisting",
      source: "referral",
      recruiter_id: "emp-rec-001",
      hiring_lead_id: "emp-hl-001",
    ...
    {
      name: "Neha Kapoor",
      email: "neha.kapoor.hr@example.com",
      phone: "+919944455566",
      whatsapp_number: "+919944455566",
      stage: "shortlisting",
      source: "job_portal",
      recruiter_id: "emp-rec-003",
      hiring_lead_id: "emp-hl-003",
